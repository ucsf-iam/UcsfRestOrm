...
class RESTStatement implements \IteratorAggregate, Statement
{
    ...
    public function __construct(Client $client, $method, $uri)
    {
        $this->client = $client;
        $this->method = $method;
        $this->uri = $uri;
    ...
    /**
     * Binds a value to a corresponding named variable within a REST URI.
    ...
    /**
     * Execute the rest method at the given URI.
     *
